  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Center(
          child: Container(
            width: 360, // Slightly adjusted width for better layout
            ...
            child: Column(
              ...
              children: [
                ...
                // Button layout with minimal spacing, wrapped in a bordered container
                Container(
                  decoration: BoxDecoration(
                    border: Border(
                      bottom: BorderSide(
                          color: Colors.black12,
                          width: 4), // Boundary only at the bottom
                    ),
                  ),
                  child: Column(
                    children: [
                      ...
                      buildRow(
                          ['1', '2', '3', '/'], Colors.orange, Colors.green),
                      buildRow(
                          ['4', '5', '6', '-'], Colors.orange, Colors.green),
                      buildRow(
                          ['7', '8', '9', 'X'], Colors.orange, Colors.green),
                      buildRow(
                          ['.', '0', '%', '+'], Colors.orange, Colors.green),
                    ],
                  ),
                ),
              ],
